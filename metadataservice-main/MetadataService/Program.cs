...
using MetadataService.InjeccionDependencias;
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    options.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Title = $"MicroServicio De Metadatos - { Environment.GetEnvironmentVariable("ASPNETCORE_ENVIRONMENT") }",
        Description = "Servicio de infodatos"
    });
...
app.UseSwaggerUI(options =>
{
    ...
    options.DocumentTitle = "Api Recepción - Metadatos";
});
